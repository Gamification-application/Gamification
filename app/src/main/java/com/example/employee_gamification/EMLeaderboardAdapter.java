...
public class EMLeaderboardAdapter extends RecyclerView.Adapter<EMLeaderboardAdapter.ViewHolder> {

    private List<com.example.employee_gamification.EMLeaderboardModel> leaderboardList;

    public EMLeaderboardAdapter(List<com.example.employee_gamification.EMLeaderboardModel> leaderboardList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        com.example.employee_gamification.EMLeaderboardModel model = leaderboardList.get(position);
